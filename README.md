<!--
**NadaSadek/NadaSadek** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
...
Tests whether a help-center assistant retrieves the correct source documents before generating an answer.
Compares keyword, embedding and hybrid retrieval strategies using metrics.

### 🖼️ AI UI QA Inspector

Analyzes UI screenshots and DOM context to produce structured frontend QA findings for accessibility, UX and implementation issues.

### 💸 Revenue Risk Inbox

A review queue for support messages that identifies revenue-risk signals and turns AI output into human-reviewable product decisions.
